...
for threshold in thresholds:
    ...
    mg.adj = 
    latent = lse(mg.adj, n_components=None)
...
stashfig(f"threshold-vs-f-norm-{graph_type}")
fig, ax = plt.subplots(1, 1, figsize=(10, 5))
sns.scatterplot(
...
ax.set_title(graph_type)
stashfig(f"threshold-vs-norm-f-norm-{graph_type}")

fig, ax = plt.subplots(1, 1, figsize=(10, 5))
sns.scatterplot(x="threshold", y="n_verts", data=res_df, legend=False, ax=ax)
ax.set_title(graph_type)
stashfig(f"threshold-vs-n-verts-{graph_type}")
...
ax.set_title(graph_type)
stashfig(f"threshold-vs-knn-{graph_type}")
