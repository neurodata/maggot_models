...
data_date_graphs = "2020-01-21"  # this is for the graph, not the annotations
...
skeleton_data_file = (
    data_path / Path(data_date_graphs) / "skeleton_id_vs_neuron_name.tsv"
)
...
meta_data_df = pd.read_csv(skeleton_data_file, delimiter="\t")
meta_data_df.head()
