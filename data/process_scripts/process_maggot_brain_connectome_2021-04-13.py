...
print(drop_df)
print("Is in duplicated pairs list:")
print(drop_df["leftid"].isin((meta[meta["duplicated_neurons"]].index)))
print(drop_df["rightid"].isin((meta[meta["duplicated_neurons"]].index)))
print("\n")
